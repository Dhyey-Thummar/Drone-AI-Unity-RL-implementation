...
public class HelicopterController : MonoBehaviour
{
    ...
    public HeliRotorController Controller1;
    public HeliRotorController Controller2;
    ...
    public float EngineForce
    {
        ...
        set
        {
            Controller1.RotarSpeed = value * 80;
            Controller2.RotarSpeed = value * 80;
    ...
    {
        float upForce = 1 - Mathf.Clamp(HelicopterModel.transform.position.y / EffectiveHeight, 0, 1);
        ...
        foreach (var pressedKeyCode in obj)
        {
            switch (pressedKeyCode)
            {
                ...
                case PressedKeyCode.SpeedDownPressed:
                    ...
                    {
                        if (IsOnGround) break;
                        float force = (turnForcePercent - Mathf.Abs(hMove.y))*HelicopterModel.mass;
