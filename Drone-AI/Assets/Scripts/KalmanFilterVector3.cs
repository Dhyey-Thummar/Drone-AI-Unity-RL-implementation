...
public class KalmanFilterVector3 : MonoBehaviour {
    ...
    public Vector3 KUpdate(Vector3 measurement, float? newQ = null, float? newR = null)
    {
    ...
    public Vector3 KUpdate(Vector3[] measurements,  bool areMeasurementsNewestFirst = false, float? newQ = null, float? newR = null)
	{
		...
		while (i < measurements.Length && i > 0)
		{
			...
			result = KUpdate(measurements[i], newQ, newR);
